...
| [`options.snowflake.desktop.ghostty.enable`](modules/home/desktop/ghostty/default.nix) | `boolean` | `false` | Enable ghostty home configuration |
| [`options.snowflake.desktop.gnome-dconf.enable`](modules/home/desktop/gnome/default.nix) | `boolean` | `false` | Enable gnome dconf home configuration |
...
| [`options.snowflake.shell.direnv.enable`](modules/home/shell/direnv/default.nix) | `boolean` | `false` | Enable direnv home configuration |
...
| [`options.snowflake.services.forgejo.sshDomain`](modules/nixos/services/forgejo/default.nix) | `lib.types.str` | `config.${namespace}.services.forgejo.domain` | SSH domain to use for the forgejo service |
